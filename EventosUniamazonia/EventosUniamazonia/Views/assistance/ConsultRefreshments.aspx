<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Layout.Master" AutoEventWireup="true" CodeBehind="ConsultRefreshments.aspx.cs" Inherits="EventosUniamazonia.Views.assistance.ConsultRefreshments" %>
                            ...
                            <table id="bootstrap-data-table1s" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">N° REFRIGERIOS</th>
