<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Layout.Master" AutoEventWireup="true" CodeBehind="RegisterRefreshments.aspx.cs" Inherits="EventosUniamazonia.Views.assistance.RegisterRefreshments" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <title>Registrar refrigerios.</title>
    <meta name="description" content="Refrigerios" />
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-10">
                                <strong class="card-title">REFRIGERIOS.</strong>
