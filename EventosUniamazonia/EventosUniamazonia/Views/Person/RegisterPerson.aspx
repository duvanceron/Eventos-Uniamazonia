                ...
                <form class="form" id="formRegisterID" runat="server" name="formularioRegistro" method="post">
                    ...
                    <div class="col-sm-5" id="segundoRegistro">
                        ...
                        <!--<div class="input-group radio">
          		        <input type="radio" id="sexMan" value="Hombre" name="sexo" >
                        <label for="sexMan" class="">Hombre</label>

                        <input type="radio" id="sexWomen" value="Mujer" name="sexo">
                        <label for="sexWomen">Mujer</label>
                    </div>-->
                        <div class="input-group">
